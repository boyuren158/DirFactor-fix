...
nod.free.mcmc.new( data, start.sub, hyper, sigma.value, sigma.prior, sprintf("permutation/rep%s/%s/perm%s/res",args[1],args[2],args[3]), burnin = 0.2, step = 1e5, thin = 100 )
